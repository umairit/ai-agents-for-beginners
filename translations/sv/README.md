...
![Generativ AI för nybörjare](../../translated_images/sv/repo-thumbnailv2.06f4a48036fde647.webp)
...
[![GitHub pull-begäran](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
...
>
> Detta repo innehåller översättningar till över 50 språk vilket avsevärt ökar nedladdningsstorleken. För att klona utan översättningar, använd sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Om du önskar få ytterligare översättningsspråk stöds dessa [här](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

[![GitHub-watcher](https://img.shields.io/github/watchers/microsoft/ai-agents-for-beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/ai-agents-for-beginners/watchers/?WT.mc_id=academic-105485-koreyst)
...
Denna kurs innehåller lektioner som täcker grunderna i att bygga AI-agenter. Varje lektion täcker sitt eget ämne så börja var du vill!

Det finns flerspråkigt stöd för denna kurs. Gå till våra [tillgängliga språk här](#-multi-language-support).

Om detta är första gången du bygger med generativa AI-modeller, kolla in vår kurs [Generative AI For Beginners](https://aka.ms/genai-beginners), som innehåller 21 lektioner om att bygga med GenAI.

Glöm inte att [stjärnmärka (🌟) detta repo](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) och [fork detta repo](https://github.com/microsoft/ai-agents-for-beginners/fork) för att köra koden.
...
Varje lektion i denna kurs innehåller kodexempel som finns i mappen code_samples. Du kan [fork detta repo](https://github.com/microsoft/ai-agents-for-beginners/fork) för att skapa din egen kopia.

Kodexemplen i dessa övningar använder Microsoft Agent Framework med Azure AI Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Kräver Azure-konto
...
För mer information om hur man kör kod för denna kurs, gå till [Course Setup](./00-course-setup/README.md).

## 🙏 Vill du hjälpa till?

Har du förslag eller hittat stavfel eller kodfel? [Skapa ett ärende](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) eller [Skapa en pull-begäran](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
|----------------------------------------------|---------------------------------------------------|------------------------------------------------------------|---------------------------------------------------------------------------------------|
| Introduktion till AI-agenter och användningsfall | [Länk](./01-intro-to-ai-agents/README.md)         | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Länk](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
### Copilot-serie
[![Copilot för AI-paret programmering](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
kontakta [opencode@microsoft.com](mailto:opencode@microsoft.com) med frågor eller kommentarer.
...
varumärken eller logotyper styrs av och måste följa
...
Användning av Microsofts varumärken eller logotyper i ändrade versioner av detta projekt får inte orsaka förvirring eller antyda Microsoft-sponsring.
Användning av tredje parts varumärken eller logotyper lyder under dessa tredje pars policyer.
...
Om du har produktfeedback eller stöter på fel vid byggande, besök:
